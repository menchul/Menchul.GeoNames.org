        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Languages = table.Column<string>(type: "varchar(max)", unicode: false, nullable: true),
                    Neighbours = table.Column<string>(type: "varchar(max)", unicode: false, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Latitude = table.Column<double>(type: "float(8)", precision: 8, scale: 5, nullable: false),
                    Longitude = table.Column<double>(type: "float(8)", precision: 8, scale: 5, nullable: false),
