...
namespace Menchul.GeoNames.org.Firebird.Migrations
{
    /// <inheritdoc />
    public partial class InitialCommit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ISO639_3 = table.Column<string>(type: "CHAR(3)", unicode: false, fixedLength: true, maxLength: 3, nullable: false),
                    ISO639_2 = table.Column<string>(type: "CHAR(3)", unicode: false, fixedLength: true, maxLength: 3, nullable: true),
                    ISO639_1 = table.Column<string>(type: "CHAR(2)", unicode: false, fixedLength: true, maxLength: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fips = table.Column<string>(type: "CHAR(2)", unicode: false, fixedLength: true, maxLength: 2, nullable: true),
                    EquivalentFipsCode = table.Column<string>(type: "CHAR(2)", unicode: false, fixedLength: true, maxLength: 2, nullable: true),
                    Name = table.Column<string>(type: "VARCHAR(100)", maxLength: 100, nullable: false),
                    ...
                    ContinentISO2 = table.Column<string>(type: "CHAR(2)", unicode: false, fixedLength: true, maxLength: 2, nullable: false),
                    TLD = table.Column<string>(type: "CHAR(3)", unicode: false, fixedLength: true, maxLength: 3, nullable: true),
                    CurrencyCode = table.Column<string>(type: "CHAR(3)", unicode: false, fixedLength: true, maxLength: 3, nullable: true),
                    CurrencyName = table.Column<string>(type: "VARCHAR(20)", unicode: false, maxLength: 20, nullable: true),
                    PhoneCode = table.Column<string>(type: "VARCHAR(20)", unicode: false, maxLength: 20, nullable: true),
                    PostalCodeFormat = table.Column<string>(type: "VARCHAR(200)", unicode: false, maxLength: 200, nullable: true),
                    PostalCodeRegex = table.Column<string>(type: "VARCHAR(200)", unicode: false, maxLength: 200, nullable: true),
                    Languages = table.Column<string>(type: "BLOB SUB_TYPE TEXT", unicode: false, nullable: true),
                    Neighbours = table.Column<string>(type: "BLOB SUB_TYPE TEXT", unicode: false, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeatureClass = table.Column<string>(type: "CHAR(1)", unicode: false, fixedLength: true, maxLength: 1, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GMTOffset = table.Column<decimal>(type: "DECIMAL(18,2)", precision: 4, scale: 2, nullable: false),
                    DSTOffset = table.Column<decimal>(type: "DECIMAL(18,2)", precision: 10, scale: 2, nullable: false),
                    RawOffset = table.Column<decimal>(type: "DECIMAL(18,2)", precision: 4, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FeatureCode = table.Column<string>(type: "VARCHAR(10)", unicode: false, maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ASCIIName = table.Column<string>(type: "VARCHAR(200)", unicode: false, maxLength: 200, nullable: false),
                    AlternateNames = table.Column<string>(type: "BLOB SUB_TYPE TEXT", nullable: true),
                    ...
                    FeatureClass = table.Column<string>(type: "CHAR(1)", unicode: false, fixedLength: true, maxLength: 1, nullable: true),
                    FeatureCode = table.Column<string>(type: "VARCHAR(10)", unicode: false, maxLength: 10, nullable: true),
                    CountryCode = table.Column<string>(type: "CHAR(2)", unicode: false, fixedLength: true, maxLength: 2, nullable: true),
                    CountryCodesAlternate = table.Column<string>(type: "VARCHAR(200)", unicode: false, maxLength: 200, nullable: true),
                    Admin1Code = table.Column<string>(type: "VARCHAR(20)", unicode: false, maxLength: 20, nullable: true),
                    Admin2Code = table.Column<string>(type: "VARCHAR(80)", unicode: false, maxLength: 80, nullable: true),
                    Admin3Code = table.Column<string>(type: "VARCHAR(20)", unicode: false, maxLength: 20, nullable: true),
                    Admin4Code = table.Column<string>(type: "VARCHAR(20)", unicode: false, maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "BLOB SUB_TYPE TEXT", nullable: false),
                    C4 = table.Column<string>(type: "BLOB SUB_TYPE TEXT", nullable: true),
                    C5 = table.Column<string>(type: "BLOB SUB_TYPE TEXT", nullable: true),
                    C6 = table.Column<string>(type: "BLOB SUB_TYPE TEXT", nullable: true),
                    C7 = table.Column<string>(type: "BLOB SUB_TYPE TEXT", nullable: true),
                    C8 = table.Column<string>(type: "BLOB SUB_TYPE TEXT", nullable: true),
                    C9 = table.Column<string>(type: "BLOB SUB_TYPE TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlternateNamesV2_GeoNameIdR~",
                schema: "gno",
